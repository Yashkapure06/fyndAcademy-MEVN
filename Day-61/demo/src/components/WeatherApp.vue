<template>
  <div class="">
    ...
    <center class="mt-5  align-self-center">
      ...
      <div class="card " style="width: 18rem;margin-top: 15px;">
        <img class="card-img-top" v-if="weather.icon" :src="`http://openweathermap.org/img/wn/${weather.icon}@2x.png`"
          alt="weather icon">
        <div class="card-body">
          <h1>{{ this.location }}</h1>
        </div>
        <ul class="list-group w-100 list-group-flush">
          <li class="list-group-item"><strong>Country</strong>: <em>{{ weather.country }}</em></li>
